defmodule Zenflows.Valflow.RoleBehavior.Type do
@moduledoc "GraphQL types of RoleBehaviors."

use Absinthe.Schema.Notation

alias Zenflows.Valflow.RoleBehavior.Resolv
