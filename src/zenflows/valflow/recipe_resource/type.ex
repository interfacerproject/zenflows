defmodule Zenflows.Valflow.RecipeResource.Type do
@moduledoc "GraphQL types of RecipeResources."

use Absinthe.Schema.Notation

alias Zenflows.Valflow.RecipeResource.Resolv
