defmodule Zenflows.Valflow.RecipeProcess.Type do
@moduledoc "GraphQL types of RecipeProcesses."

use Absinthe.Schema.Notation

alias Zenflows.Valflow.RecipeProcess.Resolv
