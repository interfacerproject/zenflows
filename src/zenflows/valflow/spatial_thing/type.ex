defmodule Zenflows.Valflow.SpatialThing.Type do
@moduledoc "GraphQL types of SpatialThings."
# Basically, a fancy name for (geo)location.  :P

use Absinthe.Schema.Notation

alias Zenflows.Valflow.SpatialThing.Resolv
