defmodule Zenflows.Valflow.ProcessSpecification.Type do
@moduledoc "GraphQL types of ProcessSpecifications."

use Absinthe.Schema.Notation

alias Zenflows.Valflow.ProcessSpecification.Resolv
